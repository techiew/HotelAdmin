namespace HotellAdmin {
	partial class LoginWindow {
		...
		private void InitializeComponent() {
			...
			this.rememberUsername.Location = new System.Drawing.Point(12, 130);
			this.rememberUsername.Name = "rememberUsername";
			this.rememberUsername.Size = new System.Drawing.Size(114, 17);
			this.rememberUsername.TabIndex = 3;
			this.rememberUsername.Text = "Husk brukernavn?";
			this.rememberUsername.UseVisualStyleBackColor = true;
			this.rememberUsername.CheckedChanged += new System.EventHandler(this.rememberUsername_CheckedChanged);
			// 
			// loginUsername
			// 
